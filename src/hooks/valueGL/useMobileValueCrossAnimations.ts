...
export const useMobileValueCrossAnimations = ({
  ...
  const createPage1CrossAnim = (tl: GSAPTimeline) => {
    ...
    tl.to(
      ...
      {
        ...page2Config.to.model.mobilePos,
        ease: 'power3.inOut',
        duration: 8,
        onComplete: () => {
  ...
  const createPage2CrossAnim = (tl: GSAPTimeline) => {
    ...
    tl.to(
      modelRef.current.position,
      {
        ...page3Config.to.model.mobilePos,
        ease: 'power3.inOut',
        duration: 8,
    ...
    tl.to(
      modelRef.current.rotation,
      {
        ...page3Config.to.model.mobileRot,
        ease: 'power3.inOut',
        duration: 8,
      },
      '<',
  ...
  const createPage3CrossAnim = (tl: GSAPTimeline) => {
    ...
    tl.to(
      modelRef.current.position,
      {
        ...page4Config.to.model.mobilePos,
        duration: 8,
        ease: 'power3.inOut',
        onComplete: () => {
    ...
    tl.to(
      modelRef.current.rotation,
      {
        ...page4Config.to.model.mobileRot,
        duration: 8,
        ease: 'power3.inOut',
      },
      '<',
