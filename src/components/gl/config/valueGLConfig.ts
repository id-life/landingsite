export const VALUE_GL_CONFIG = [
  // Page 1
  {
    ...
    to: {
      ...
      model: {
        ...
        mobilePos: { x: 0, y: -11.5, z: 0 },
        rotation: { x: 0, y: 0, z: 0 },
        mobileRot: { x: -0.2, y: -2, z: 0 },
      },
    },
  },
  // Page 2
  {
    ...
    to: {
      ...
      model: {
        ...
        mobilePos: { x: -1, y: -10, z: 0 },
        rotation: { x: 0, y: 0, z: 0 },
        mobileRot: { x: 0, y: -2, z: 0 },
      },
    },
  },
  // Page 3
  {
    ...
    to: {
      ...
      model: {
        ...
        mobilePos: { x: -1, y: -12, z: -2 },
        rotation: { x: 0, y: 0, z: 0 },
        mobileRot: { x: -0.5, y: 1, z: 0 },
      },
    },
  },
  // Page 4
  {
    ...
    to: {
      ...
      model: {
        position: { x: 0, y: -10, z: 0 },
        mobilePos: { x: -0.5, y: -10, z: 0 },
        rotation: { x: 0, y: 0, z: 0 },
        mobileRot: { x: 1.2, y: 0, z: 0 },
      },
    },
  },
  // Page 5
  ...
  // Page 6
  {
    ...
    to: {
      ...
      model: {
        ...
        mobilePos: { x: -0.5, y: -10.8, z: 2 },
        rotation: { x: 0, y: 0, z: 0 },
        mobileRot: { x: 0, y: 0, z: 0 },
      },
    },
  },
] as const;
