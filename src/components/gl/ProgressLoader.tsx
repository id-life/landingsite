...
export function OuterLoader() {
  ...
  return <ProgressLoader ref={progressRef} progress={animatedProgressRef.current.toFixed(2)} />;
}

const ProgressLoader = forwardRef<any, { progress: string }>((props, ref) => {
  ...
  return (
    <FloatingPortal>
      <FloatingOverlay className="z-[500] grid place-items-center">
        <Background />
        <svg width={200} ref={ref} viewBox="0 0 106 62" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
