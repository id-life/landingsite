...
export default function Contact() {
  ...
  return (
    <div
      ...
      className="group relative w-52 cursor-pointer bg-white/10 py-3.5 text-center text-base/5 font-semibold backdrop-blur duration-300 hover:text-red-600 mobile:absolute mobile:top-0 mobile:w-44 mobile:-translate-x-1/2 mobile:text-xs/5"
    >
      <SubscribeBorderSVG
