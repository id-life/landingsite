...
export const MobileDiseaseManagementStatusItem: FC<DiseaseManagementStatusItemType> = ({
  img,
  title,
  counts,
  data,
  ...
  return (
    <div className="hidden w-full flex-col items-center font-semibold text-white mobile:flex">
