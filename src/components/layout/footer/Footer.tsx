  ...
  return (
    <>
      ...
      <FloatingPortal>
        <div
          ref={subscribeRef}
          className="page-footer fixed -bottom-80 z-10 flex w-full items-center justify-center mobile:inset-x-5 mobile:h-auto mobile:w-auto"
        >
          
          <div className="footer-box-clip items mx-10 flex w-full justify-between bg-white/40 p-10 backdrop-blur mobile:p-4">
            <div>
              <img className="w-[8.125rem]" src="/svgs/logo.svg" alt="" />
              <div className="mt-18 flex gap-10">
                <div className="flex-center relative h-10 w-10 cursor-pointer">
                  <img className="absolute left-0 top-0 w-full" src="/svgs/border.svg" alt="" />
                  <img className="" src="/svgs/youtube.svg" alt="" />
                </div>
                <div className="flex-center relative h-10 w-10 cursor-pointer">
                  <img className="absolute left-0 top-0 w-full" src="/svgs/border.svg" alt="" />
                  <img className="" src="/svgs/linkedin.svg" alt="" />
                </div>
                <div className="flex-center relative h-10 w-10 cursor-pointer">
                  <img className="absolute left-0 top-0 w-full" src="/svgs/border.svg" alt="" />
                  <img className="" src="/svgs/media.svg" alt="" />
                </div>
              </div>
            </div>
