...
const AnimationGroup = forwardRef<AnimationGroupHandle, AnimationGroupProps>(({ modelRef }, ref) => {
  const { nodes, materials, animations } = useGLTF('https://resources.id.life/m2/test-v1.glb') as unknown as {
    nodes: {
      JCO_short_usa001: THREE.SkinnedMesh;
      JCO_Tshirt_USA001: THREE.SkinnedMesh;
      ...
      Layered_Straight_Hair001: THREE.SkinnedMesh;
  ...
  const fade = (
    ...
    target.traverse((child) => {
      if ((child as THREE.Mesh).material) {
        ...
        if (Array.isArray(mat)) {
          ...
          if (['基本眼睛rb111', '基本c或nearb112', '基本眼睛lb113', '基本c或nealb114'].includes(mat.name)) {
            mat.transparent = false; // 在淡出后禁用深度写入
          }
          child.renderOrder = 1; // 材质渲染顺序
          if (mat.name == '毛发透明度b116') {
    ...
    const animate = (time: number) => {
      ...
      materials.forEach((mat) => {
        ...
        if (mat.name === '基本c或nearb112' || mat.name === '基本c或nealb114') {
      ...
      if (target === 'modelRef') {
        ...
        if (animationGroupRef.current) {
          ...
          animationGroupRef.current.traverse((object: any) => {
            if (
              object.material &&
              (object.material.name === '基本眼睛rb111' ||
                object.material.name === '基本c或nearb112' ||
                object.material.name === '基本眼睛lb113' ||
                object.material.name === '基本c或nealb114')
            ) {
  ...
  return (
    ...
    <group name="Armature" ref={animationGroupRef} rotation={[Math.PI / 2, 0, 0]} scale={0.055}>
      ...
      <skinnedMesh
        ...
        material={materials.canvasshoesb115}
      ...
      <group name="CC_Base_Eye002">
        ...
        <skinnedMesh
          ...
          material={materials.基本c或nearb112}
        ...
        <skinnedMesh
          ...
          material={materials.基本c或nealb114}
      ...
      <group name="CC_Base_EyeOcclusion002">
        <skinnedMesh
          ...
          material={materials.基本眼部阻塞rb106}
        ...
        <skinnedMesh
          ...
          material={materials.基本眼部阻塞lb107}
      ...
      />
      <skinnedMesh
        name="JCO_short_usa001"
        geometry={nodes.JCO_short_usa001.geometry}
        material={materials.jcosh或tusab102}
        skeleton={nodes.JCO_short_usa001.skeleton}
        castShadow
        receiveShadow
      />
      <skinnedMesh
        name="JCO_Tshirt_USA001"
        geometry={nodes.JCO_Tshirt_USA001.geometry}
        material={materials.jcotshirtusab103}
        skeleton={nodes.JCO_Tshirt_USA001.skeleton}
        castShadow
        receiveShadow
      />
      <skinnedMesh
        name="Layered_Straight_Hair001"
        geometry={nodes.Layered_Straight_Hair001.geometry}
        material={materials.毛发透明度b116}
        skeleton={nodes.Layered_Straight_Hair001.skeleton}
        castShadow
        receiveShadow
      />
