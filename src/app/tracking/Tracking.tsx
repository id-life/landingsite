      ...
      <div className="mt-12">
        <div className="flex h-112 w-3/4 gap-5">
          {Tracking_List.map((item, index) => (
            ...
            >
              <ArrowMarkSVG className="absolute left-0 top-0 w-7.5 fill-gray-800 duration-500 group-hover:fill-red-600" />
