  ...
  return (
    <div className={cn('flex items-center justify-between p-10 mobile:p-5', className)}>
      ...
      <div
        ...
        className="group relative z-[100] flex h-12 w-51.5 cursor-pointer items-center justify-center text-sm font-semibold uppercase text-foreground transition-colors duration-300 hover:stroke-red-600 hover:text-red-600 mobile:h-8 mobile:w-24 mobile:text-xs/5"
      >
