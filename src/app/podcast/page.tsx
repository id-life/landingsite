...
const jsonLd: WithContext<PodcastSeries> = {
  ...
  image: 'https://resources.id.life/audio/idfm_logo@small.webp',
  publisher: {
    '@type': 'Organization',
  ...
  hasPart: [
    {
      ...
      associatedMedia: {
        '@type': 'MediaObject',
        contentUrl: 'https://resources.id.life/audio/podcast/id_ep01.mp3',
      },
      description:
    ...
    },
    {
      ...
      associatedMedia: {
        '@type': 'MediaObject',
        contentUrl: 'https://resources.id.life/audio/podcast/id_ep02.mp3',
      },
      description:
    ...
    },
    {
      ...
      associatedMedia: {
        '@type': 'MediaObject',
        contentUrl: 'https://resources.id.life/audio/podcast/id_ep03.mp3',
      },
      description:
    ...
    },
    {
      ...
      associatedMedia: {
        '@type': 'MediaObject',
        contentUrl: 'https://resources.id.life/audio/podcast/id_ep04.mp3',
      },
      description:
