    ...
    <div ref={wrapperRef} id={NAV_LIST[0].id} className="page-container">
      ...
      <div ref={visionBottomRef} className="group pointer-events-none absolute inset-0 -z-10 select-none">
        <img
          ...
          draggable={false}
          className="absolute left-1/2 top-[calc(100vh_-_8rem)] w-[35.625rem] -translate-x-1/2 text-gray-800 mobile:top-[calc(100vh_-_5.625rem)] mobile:w-[18.75rem] mobile:-translate-y-1/2"
          alt="TIL UNLIMITED HUMAN HEALTHY LIFESPAN"
        />
        <div className="absolute left-1/2 top-[calc(100vh_-_5rem)] flex -translate-x-1/2 items-center gap-2 mobile:top-[calc(100vh_-_3.375rem)] mobile:rounded-lg mobile:bg-white/50 mobile:px-1.5 mobile:py-2 mobile:backdrop-blur-2xl">
