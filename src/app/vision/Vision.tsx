    ...
    <div ref={wrapperRef} id={NAV_LIST[0].id} className="page-container">
      ...
      <div ref={visionBottomRef} className="group pointer-events-none absolute inset-0 -z-10 select-none">
        <img
          ...
          draggable={false}
          className="absolute left-1/2 top-[calc(100vh_-_8rem)] w-[35.625rem] -translate-x-1/2 text-gray-800 mobile:top-[calc(50vh_+_6rem)] mobile:w-[18.75rem] mobile:-translate-y-1/2"
