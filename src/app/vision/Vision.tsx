  ...
  return (
    <div ref={wrapperRef} id={NAV_LIST[0].id} className="page-container">
      <div ref={visionBottomRef} className="group pointer-events-none absolute inset-0 -z-10 select-none">
        <div className="absolute left-1/2 top-[calc(100dvh_-_6rem)] -translate-x-1/2 items-center gap-2 mobile:top-[calc(100dvh_-_3.375rem)] mobile:rounded-lg mobile:bg-white/50 mobile:px-1.5 mobile:py-2 mobile:backdrop-blur-2xl">
